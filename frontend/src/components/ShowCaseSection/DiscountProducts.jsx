...
import { Sparkles, ChevronLeft, ChevronRight, Percent } from 'lucide-react';
...
const DiscountProducts = () => {
  ...
  // Filter products that have discount (discount exists and value > 0)
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center bg-gradient-to-br from-white via-red-50/30 to-white dark:from-black dark:via-red-950/20 dark:to-black">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400 animate-pulse">Loading discount products...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">
            Grab the best deals on premium instruments with exclusive discounts
          </p>
        </div>
