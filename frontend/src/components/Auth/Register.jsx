  ...
  return (
    <div className="p-8 sm:p-10 h-full flex flex-col justify-center grow">
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <button className="w-full bg-red-600 hover:bg-red-700 text-white rounded-2xl py-4 font-bold tracking-wide shadow-lg shadow-red-600/25 hover:shadow-red-600/40 transition-all flex items-center justify-center gap-2 group mt-4">
          <span>Sign Up</span>
